            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm">
                            <a class="opacity-5 text-white" href="{{ route('sub-kriteria', $sub_kriteria->id_kriteria) }}">{{ $sub_kriteria->kriteria->kriteria }}</a>
                        </li>
                    </ol>
                    <h4 class="font-weight-bolder text-white mb-0">Edit Sub Kriteria</h4>
                </nav>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="deskripsi" value="{{ $sub_kriteria->desc }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Bobot</label>
                                            <input class="form-control" type="number" name="bobot" value="{{ $sub_kriteria->rate }}" required>
                                        </div>
                                    </div>
